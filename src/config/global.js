export default {
  ...
  referencias: [
    {
      referencia:
        'Aldean, V. F. O. et al. (2019). <i>Direccionamiento Estratégico Con Cuadro De Mando Integral Para Firmas Auditoras - Strategic Direction with Balanced Scorecard for Audit Firms. Journal of Software Engineering and Simulation, 5</i>(1), 1-15.',
      link: '',
    },
    {
      referencia:
        'Arrieta, V., Cervantes, Y., De la Cruz, L.  & López, D.  (2021).  La importancia del diagnóstico estratégico en las organizaciones.  <i>Económicas CUC, 42</i>(2), 243–254.',
      link: '',
    },
    {
      referencia:
    ...
    {
      referencia:
        'Delgado, J. E. (2020). La integración vertical empresarial, una visión estratégica: Caso Apple Inc. <i>Tekhné, 23</i>(3).',
      link: '',
    },
    {
      referencia:
